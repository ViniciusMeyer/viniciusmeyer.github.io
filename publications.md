...
<div class="media">
    <div class="media-body">
       <p class="media-heading">
          <img src="../img/JSSoftw.jpg" alt="JSS" width="500" height="600"><strong> IADA: A dynamic interference-aware cloud scheduling architecture for latency-sensitive workloads.</strong><br />
